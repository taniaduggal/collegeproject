...
<header id="header">
    <div class="container">
        <h1 class="PNG image(.png)">
<a href="index.php"><img src="sk.jpg" width="111" height="111" data-sticky-width="40"data-sticky-height="40" src="sk.jp"> University Management System</a>
        </h1>
